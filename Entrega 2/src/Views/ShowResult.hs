...
--
-- Imprime a pontuação de um time específicado (RF2).
--
showRankTeam :: Team -> [TeamResult] -> IO ()
showRankTeam _ [] = putStrLn $ U.red ++ "Não há classificação." ++ U.reset
showRankTeam team matches = do